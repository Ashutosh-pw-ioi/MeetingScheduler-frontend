    ...
    <div className="w-full mx-auto px-2 sm:px-0 h-[550px]">
      <div className="bg-white rounded-lg shadow-lg p-3 sm:p-4 md:p-2 relative h-full">
        <button
          ...
          className="text-white px-3 py-3 sm:px-2 sm:py-2 hover:bg-gray-800 transition-colors cursor-pointer bg-black duration-200 ease-in-out shadow-md absolute z-10 right-0 top-0 rounded-b-full rounded-l-full"
        ...
        <div
          className={`relative border-2 border-dashed rounded-lg py-6 sm:py-2 px-4 sm:px-6 md:px-8 text-center transition-all duration-200 h-full flex items-center justify-center ${
            dragActive
          ...
          {uploadStatus === "success" ? (
            ...
            <div className="space-y-2">
              ...
              <div>
                ...
                <p className="text-sm sm:text-base text-red-600 mb-2 px-2 break-words">
                  {errorMessage}
                </p>
                <button
                  onClick={removeFile}
                  className="w-full sm:w-auto px-6 py-3 sm:px-4 sm:py-2 bg-black text-white rounded-lg hover:bg-gray-800 cursor-pointer transition-colors relative z-10 text-sm sm:text-base font-medium"
                >
                  Try Again
                </button>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-3">
                  <button
                    onClick={removeFile}
                    className="w-full sm:w-auto px-6 py-3 sm:px-4 sm:py-2 border border-[#1B3A6A] rounded-lg hover:bg-gray-100 transition-colors relative z-10 text-sm sm:text-base font-medium cursor-pointer"
                  >
                    Remove
                  </button>
                  <button
                    onClick={uploadFile}
                    className="w-full sm:w-auto px-6 py-3 sm:px-4 sm:py-2 bg-black text-white rounded-lg hover:bg-gray-800 duration-200 ease-in-out transition-colors relative z-10 text-sm sm:text-base font-medium cursor-pointer"
                  >
                    Upload Data
                  </button>
                </div>
